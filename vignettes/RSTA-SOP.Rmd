...
For traditional meta-analysis it has been custom to use the inconsistency (I2) for calculating heterogeneity [2]. This can also be used in the TSA, but it is recommended to calculate and adjust for diversity (D2) [10]. Diversity is a more conservative estimate for heterogeneity affecting the required information size if heterogeneity is present. The TSA will then present a diversity adjusted required information size (DARIS) [10]. For meta-analysis where the required information size is not reached and a 0% heterogeneity is found, a predefined subgroup analysis adjusting for diversity between 25% to 50% could be relevant. Including more future trials will increase the risk of an increase in heterogeneity. This should then be clearly predefined in the protocol.
