...
- The minimum clinically relevant difference $\theta$.
- Common probability of event $p_C$.
- test type (one- or two-sided), type-I-error and type-II error levels.
