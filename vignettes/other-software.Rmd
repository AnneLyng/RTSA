...
If we want a function that combines the metaPrepare function and the TSA function, then we can use the RTSA function. This function prints the outcome of the TSA function without the need to specify the metaPrepare function, as it is imbedded in the RTSA function. 
